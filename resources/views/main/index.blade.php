                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 col-lg-3">
                        <ul class="footer-vertical-nav">
                            <li class="menu-title"><a href="{{asset('pages/news-post.html')}}">News</a></li>
                            <li><a href="{{asset('index.html')}}">Home</a></li>
                            <li><a href="{{asset('pages/world.html')}}">World</a></li>
                            <li><a href="{{asset('pages/author.html')}}">Magazine</a></li>
                            <li><a href="{{asset('pages/business.html')}}">Business</a></li>
                            <li><a href="{{asset('pages/politics.html')}}">Politics</a></li>
                        </ul>
                    </div>
                    <div class="col-sm-3 col-lg-3">
                        <ul class="footer-vertical-nav">
                            <li class="menu-title"><a href="{{asset('pages/world.html')}}">World</a></li>
                            <li><a href="{{asset('pages/sports.html')}}">Sports</a></li>
                            <li><a href="{{asset('pages/art.html')}}">Art</a></li>
                            <li><a href="#">Magazine</a></li>
                            <li><a href="{{asset('pages/real-estate.html')}}">Real estate</a></li>
                            <li><a href="{{asset('pages/travel.html')}}">Travel</a></li>
                            <li><a href="{{asset('pages/author.html')}}">Author</a></li>
                        </ul>
                    </div>
                    <div class="col-sm-3 col-lg-3">
                        <ul class="footer-vertical-nav">
                            ...
                            <li><a href="{{asset('pages/news-post.html')}}">Newsletters</a></li>
                    ...
                    <div class="col-sm-3 col-lg-3">
                        <ul class="footer-vertical-nav">
                            ...
                            <li><a href="{{asset('pages/contactus.html')}}">Contact</a></li>
                        </ul>
                    </div>
                </div>
                <div class="row">
